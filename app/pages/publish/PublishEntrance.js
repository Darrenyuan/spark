          ...
          <View style={{ flex: 1, alignItems: "stretch" }}>
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    source={require("../../assets/image/publish_topic.png")}
                  />
                  <Text
                ...
                >
                  <Image
                    source={require("../../assets/image/publish_together.png")}
                  />
                  <Text
                    style={{ color: "white", fontSize: 16, paddingTop: 10 }}
                  >
                ...
                >
                  <Image
                    source={require("../../assets/image/publish_second_hand.png")}
                  />
                  <Text
                    style={{ color: "white", fontSize: 16, paddingTop: 10 }}
                  >
                ...
                >
                  <Image
                    source={require("../../assets/image/publish_dynamic.png")}
                  />
                  <Text
                    style={{ color: "white", fontSize: 16, paddingTop: 10 }}
                  >
