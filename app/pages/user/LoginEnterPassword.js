...
import { StyleSheet, Text, View, Image, ImageBackground, TextInput, TouchableOpacity, Keyboard } from 'react-native';
					...
					>
						...
						>
							...
							<View style={{ justifyContent: 'flex-end', marginLeft: 10 }}>
								...
								<Text style={{ fontSize: 14, color: 'white', marginBottom: 2 }}>{'重新发现身边的世界'}</Text>
							</View>
						</View>
					</ImageBackground>
