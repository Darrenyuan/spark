...
export function apiLogin(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=login', {
    ...defaultArgs,
    phone: args.phone,
...
export function apiApplyLogon(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=applyLogon', {
    ...defaultArgs,
...
export function apiList(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=list', {
    ...defaultArgs,
...
export function apiSjTypeInfo(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=sjTypeInfo', {
    ...defaultArgs,
    sjType: args.sjType /*主题分类*/,
  });
}
...
export function apiAdd(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=add', {
    ...defaultArgs,
    sjType: args.sjType /*主题分类*/,
...
export function apiDetail(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=detail', { ...defaultArgs, sjid: args.sjid });
}

export function apiAgreeList(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=agreeList', { ...defaultArgs, sjid: args.sjid });
}

export function apiCommentList(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=commentList', {
    ...defaultArgs,
    sjid: args.sjid,
  });
}
...
export function apiCollectList(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=collectList', {
    ...defaultArgs,
    sjid: args.sjid,
  });
}
...
export function apiAgree(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=agree', {
    ...defaultArgs,
    sjid: args.sjid,
...
export function apiComment(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=comment', {
    ...defaultArgs,
    sjid: args.sjid,
...
export function apiCollect(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=colllect', {
    ...defaultArgs,
    sjid: args.sjid,
...
export function apiUserInfo(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=userInfo', {
    ...defaultArgs,
...
export function apiEditMyInfo(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=editMyInfo', {
    ...defaultArgs,
    nickName: args.nickName /*昵称*/,
    phone: args.phone,
    sex: args.sex /*性别：男，女*/,
...
export function apiEditNickName(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=editNickName', {
    ...defaultArgs,
    nickName: args.nickName /*昵称*/,
  });
}
...
export function apiEditFace(args = {}) {
  let defaultArgs = getDefaultArgs(args);
  return instance.post(baseUrl + 'HICService.y?cmd=editFace', {
    ...defaultArgs,
