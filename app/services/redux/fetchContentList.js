...
export function reducer(state, action) {
  switch (action.type) {
    ...
    case FETCH_CONTENT_LIST_SUCCESS:
      ...
      if (action.data.keyword === '' || action.data.keyword === undefined) {
        return {
          ...state,
          contentList: {
            ...state.contentList,
            default: {
              ...state.contentList.default,
              byId: { ...state.contentList.default.byId, ...byId },
              items: items,
        ...
        let keyword = action.data.keyword;
        let originalData = state.contentList[keyword];
        let initData = {};
        if (originalData !== undefined) {
          initData = { ...originalData };
        }
        state.contentList[keyword] = {
          ...initData,
          byId: { ...state.contentList.default.byId, ...byId },
          items: items,
          keyword: action.data.keyword,
